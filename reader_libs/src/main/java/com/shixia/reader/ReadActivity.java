...
import com.shixia.reader.db.BookMarks;
import com.shixia.reader.dialog.PageModeDialog;
import com.shixia.reader.dialog.SettingDialog;
import com.shixia.reader.utils.BrightnessUtil;
import com.shixia.reader.utils.Config;
import com.shixia.reader.utils.PageFactory;
import com.shixia.reader.widget.PageWidget;
...
//    private SpeechSynthesizer mSpeechSynthesizer;
    ...
    protected void initData() {
        ...
        Log.e("lzr", "书本内容==" + bookList.toString());
...
//    }
    ...
    public void onClick(View v) {
        int viewId = v.getId();
        if (viewId == R.id.tv_progress) {
            return;
        } else if (viewId == R.id.rl_progress) {
            return;
        } else if (viewId == R.id.tv_pre) {
            pageFactory.preChapter();
        } else if (viewId == R.id.sb_progress) {
            return;
        } else if (viewId == R.id.tv_next) {
            pageFactory.nextChapter();
        } else if (viewId == R.id.tv_directory) {
            Intent intent = new Intent(ReadActivity.this, MarkActivity.class);
            startActivity(intent);
        } else if (viewId == R.id.tv_dayornight) {
            changeDayOrNight();
        } else if (viewId == R.id.tv_pagemode) {
            hideReadSetting();
            mPageModeDialog.show();
        } else if (viewId == R.id.tv_setting) {
            hideReadSetting();
            mSettingDialog.show();
        } else if (viewId == R.id.bookpop_bottom) {
            return;
        } else if (viewId == R.id.rl_bottom) {
            return;
        } else if (viewId == R.id.tv_stop_read) {
            return;
        }
    }
}
